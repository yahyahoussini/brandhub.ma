      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between mb-12 animate-fade-in">
          ...
          <StarBorder
            ...
            className="hidden md:flex items-center border border-border bg-background hover:bg-muted px-4 py-2"
            speed="4s"
        ...
        <div className="text-center md:hidden">
          <StarBorder
            ...
            to="/blog"
            aria-label="Voir tous les articles du blog"
            className="inline-flex items-center border border-border bg-background hover:bg-muted px-4 py-2"
            speed="4s"
            color="hsl(var(--primary))"
          >
