          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              <StarBorder
                ...
                className="gradient-accent text-foreground hover:shadow-accent transition-smooth font-semibold px-8 py-6 text-lg group flex items-center"
                speed="2.5s"
              ...
              <StarBorder
                as="a"
                href="tel:+212607076940"
                className="bg-white/10 backdrop-blur-sm border-white/30 text-white hover:bg-white/20 px-8 py-6 text-lg transition-smooth flex items-center"
                speed="3.5s"
